...
public class Utilidades {
	public static void agregarCincoRecetas() {
		...
		tiempoCoccion = 40;
		fotos = "https://cdn0.recetasgratis.net/es/posts/7/9/2/lomo_a_la_naranja_con_mostaza_46297_600.webp" + "\n\n";
		RecetasChef recetasChefEnCasa2 = new RecetasChef(titulo, descripcion, tiempoCoccion, ingredientes, pasos,
				fotos);
		...
		tiempoCoccion = 30;
		fotos = "https://cdn0.recetasgratis.net/es/posts/2/3/9/ensalada_de_pasta_con_atun_76932_600.webp" + "\n\n";
		RecetasChef recetasChefEnCasa3 = new RecetasChef(titulo, descripcion, tiempoCoccion, ingredientes, pasos,
				fotos);
		...
		tiempoCoccion = 45;
		fotos = "https://cdn0.recetasgratis.net/es/posts/0/8/6/pescado_a_lo_macho_76680_600.webp" + "\n\n";
		RecetasChef recetasChefEnCasa4 = new RecetasChef(titulo, descripcion, tiempoCoccion, ingredientes, pasos,
				fotos);
		...
		tiempoCoccion = 45;
		fotos = "https://cdn0.recetasgratis.net/es/posts/3/4/9/noquis_de_calabaza_y_papa_76943_600.webp" + "\n\n";
		RecetasChef recetasChefEnCasa5 = new RecetasChef(titulo, descripcion, tiempoCoccion, ingredientes, pasos,
				fotos);
